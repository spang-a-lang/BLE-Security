      ...
      characteristics: [
        {
          ...
          properties: ['read'],
          secure: [],
          value: new Buffer([0x4d, 0x65, 0x73, 0x68, 0x4d, 0x6f, 0x74, 0x69, 0x6f, 0x6e]),
          descriptors: []
        },
        {
          uuid: '2a24',
          ...
          secure: [],
          value: new Buffer([0x30, 0x30, 0x2e, 0x30, 0x35]),
          descriptors: []
        },
		{
          uuid: '2a23',
          properties: ['read'],
          secure: [],
          value: new Buffer([0x30, 0x30, 0x30, 0x30, 0x30, 0x64, 0x32, 0x36]),
          descriptors: []
        },
	]
	},
